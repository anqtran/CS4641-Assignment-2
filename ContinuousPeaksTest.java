...
double start,end,testingTime;
        ...
        PrintWriter pw = new PrintWriter(new File("testFitnessCP.csv"));
        StringBuilder sb = new StringBuilder();

        PrintWriter pw1 = new PrintWriter(new File("testTimeCP.csv"));
        ...
        for (int i  = 1; i<=8001; i+= 1000) {            
            ...
            start = System.nanoTime();
            SimulatedAnnealing sa = new SimulatedAnnealing(1E2, .95, hcp);
